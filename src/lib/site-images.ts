...
export const SITE_IMAGES = {
  ...
  proteinShake: '/images/protein-shakes/menu-poster.png',
  ...
  categories: {
    ...
    'protein-bowls': '/images/acai-protein-bowl-crunchy-monkey.jpg',
    'protein-coffee': '/images/protein-coffee/iced-lineup.png',
    'protein-shakes': '/images/protein-shakes/menu-poster.png',
